    ...
    <div>
      ...
      <section id="contact" className="scroll-mt-20 border-b border-line">
        <div className="mx-auto max-w-6xl px-5 py-16 text-center sm:px-8 sm:py-24">
          ...
          <a
            href={`mailto:${s.email}`}
            className="mt-8 inline-flex items-center gap-2 rounded-full bg-accent px-7 py-3.5 text-sm font-semibold text-white shadow-card transition-colors hover:bg-accent/90"
          >
            {s.email}
